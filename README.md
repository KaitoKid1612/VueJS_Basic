...
#### Ep11 | #01 | Cơ bản về Input bind dữ liệu và nhóm dữ liệu Vue.js

#### Ep11 | #02 | Modifying Input với Modifiers trong Vue.js

#### Ep11 | #03 | Bind dữ liệu textarea và lưu kí tự xuống dòng Vue.js

#### Ep11 | #04 | Sử dụng checkboxes và lưu dữ liệu vào mảng Vue.js

#### Ep11 | #05 | Sử dụng Radio Buttons cho form trong Vue.js

#### Ep11 | #06 | Xử lí Dropdowns với Select và Options Vue.js

#### Ep11 | #07 | Cách làm việc của v-model trong Vue.js
